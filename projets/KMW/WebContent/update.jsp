...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="updateAction.jsp?newsID=<%= newsID %>">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글 제목" name="newsTitle" maxlength="50" value="<%= news.getNewsTitle() %>"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="newsContent" maxlength="2048" style="height: 350px;"><%= news.getNewsContent() %></textarea></td>
						</tr>
					</tbody>
				</table>
